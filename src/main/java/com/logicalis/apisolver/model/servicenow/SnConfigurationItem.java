...
@Entity
public class SnConfigurationItem implements Serializable {
    ...
    public String getModel_categories() {
        return model_categories;
    }

    public void setModel_categories(String model_categories) {
    ...
    public String getManaged_domain() {
        return managed_domain;
    }

    public void setManaged_domain(String managed_domain) {
