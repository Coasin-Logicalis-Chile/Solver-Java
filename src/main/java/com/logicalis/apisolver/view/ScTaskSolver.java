...
public class ScTaskSolver {
    ...
    public String getAgile_story() {
        return agile_story;
    }

    public void setAgile_story(String agile_story) {
        this.agile_story = agile_story;
    }
    ...
    public String getNeeds_attention() {
        return needs_attention;
    }

    public void setNeeds_attention(String needs_attention) {
        this.needs_attention = needs_attention;
    }
    ...
    public String getU_cat_item() {
        return u_cat_item;
    }

    public void setU_cat_item(String u_cat_item) {
        this.u_cat_item = u_cat_item;
    }

    public String getU_reopen_count() {
        return u_reopen_count;
    }

    public void setU_reopen_count(String u_reopen_count) {
        this.u_reopen_count = u_reopen_count;
    }

    public String getU_request_item() {
        return u_request_item;
    }

    public void setU_request_item(String u_request_item) {
        this.u_request_item = u_request_item;
    }
    ...
    public void setScaling_assigned_to(String scaling_assigned_to) {
        this.scaling_assigned_to = scaling_assigned_to;
    }

    public String getScaling_assignment_group() {
        return scaling_assignment_group;
    }
    ...
    public boolean getU_solver_flag_closed_by() {
        return u_solver_flag_closed_by;
    }

    public void setU_solver_flag_closed_by(boolean u_solver_flag_closed_by) {
        this.u_solver_flag_closed_by = u_solver_flag_closed_by;
    }
    ...
    public boolean isU_solver_flag_closed_by() {
        return u_solver_flag_closed_by;
    }
    ...
    public String getRequest_item_number() {
        return request_item_number;
    }

    public void setRequest_item_number(String request_item_number) {
        this.request_item_number = request_item_number;
    }
