			...
			for (String sparmOffSet : sparmOffSets) {
				...
				ListSnConfigurationItemJson.stream().forEach(configurationItemSolverJson -> {
					...
					try {
						...
						if (exists[0] != null) {
							configurationItem.setId(exists[0].getId());
							tagAction[0] = App.UpdateConsole();
						}
						configurationItem.setName(configurationItemSolver[0].getName());
						configurationItem.setIntegrationId(configurationItemSolver[0].getSys_id());
						configurationItem.setDescription(configurationItemSolver[0].getDescription());
						configurationItem.setStatus(configurationItemSolver[0].getStatus());
						configurationItem.setUpdated(configurationItemSolver[0].getUpdated());
						configurationItem.setCreatedBy(configurationItemSolver[0].getSys_created_by());
						configurationItem.setAssetTag(configurationItemSolver[0].getAsset_tag());
						configurationItem.setAssigned(configurationItemSolver[0].getAssigned());
						configurationItem.setCategory(configurationItemSolver[0].getCategory());
						configurationItem.setComments(configurationItemSolver[0].getComments());
						configurationItem.setCorrelationId(configurationItemSolver[0].getCorrelation_id());
						configurationItem.setCostCurrency(configurationItemSolver[0].getCost_cc());
						configurationItem.setCreated(configurationItemSolver[0].getSys_created_on());
						configurationItem.setHostname(configurationItemSolver[0].getHostname());
						configurationItem.setImpact(configurationItemSolver[0].getImpact());
						configurationItem.setInstalled(configurationItemSolver[0].getInstalled());
						configurationItem.setModelNumber(configurationItemSolver[0].getModel_number());
						configurationItem.setMonitor(configurationItemSolver[0].getMonitor());
						configurationItem.setOperationalStatus(configurationItemSolver[0].getOperational_status());
						configurationItem.setSerialNumber(configurationItemSolver[0].getSerial_number());
						configurationItem.setSpecialInstruction(configurationItemSolver[0].getSpecial_instruction());
						configurationItem.setSubcategory(configurationItemSolver[0].getSubcategory());
						configurationItem.setUpdatedBy(configurationItemSolver[0].getSys_updated_by());
						...
						configurationItem.setCompany(company[0]);
						configurationItem.setDomain(company[0].getDomain());
						...
						configurationItem.setLocation(location[0]);
						...
						configurationItem.setManufacturer(manufacturer[0]);
						...
						configurationItem.setSupportGroup(supportGroup[0]);

						configurationItemService.save(configurationItem);
						configurationItems.add(configurationItem);
						Util.printData(tag, count[0], tagAction[0].concat(Util.getFieldDisplay(configurationItem)), Util.getFieldDisplay(company[0]), Util.getFieldDisplay(company[0].getDomain()));
						count[0] = count[0] + 1;
					} catch (Exception e) {
